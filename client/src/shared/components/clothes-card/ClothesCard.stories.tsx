...
import ClothesCard from '~/shared/components/clothes-card/ClothesCard';

const ClothesCardContainer = styled.div`
  width: 25vw;
  * {
...
const meta: Meta<typeof ClothesCard> = {
  title: 'Components/ClothesCard',
